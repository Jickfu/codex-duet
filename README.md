...
This release includes the **Frozen M2 GitHub Mode MVP** data plane and the frozen M3.0, M3.1, M3.2a, and M3.2b Desktop contracts. M3.2b deterministic `EXECUTING` crash reconciliation passed real Desktop Crash A/B acceptance. M3.2c Compact Browser Control and Resume UX is in progress. Local MCP, cloudflared, and PR automation are not implemented.
